...
import {ChainId, ERC20_ABI, qERC20_ABI, tokenContracts} from "../common/Common";
import ImageToken from "../assets/tokens/ImageToken";

const Creda_ABI = require('../abiJson/CredaTest.json');
const NFTStore_ABI = require('../abiJson/NFTStore.json');
const CreditNFT_ABI = require('../abiJson/CreditNFT.json');
const CredaTestPlus_ABI = require('../abiJson/CredaTestPlus.json');
const InitializeAddress_ABI = require('../abiJson/InitializeAddress.json');
const Items_ABI = require('../abiJson/Items.json');
const GameBuild_ABI = require('../abiJson/GameBuild.json');
const Collection_ABI = require('../abiJson/Collection.json');
const Vault_ABI = require('../abiJson/Vault.json');
const IFNTunlock_ABI = require('../abiJson/IFNTunlock.json');
const IFNT_ABI = require('../abiJson/IFNT.json');

const MdexRouter_ABI = require('../abiJson/MdexRouter.json');
const MdexFactory_ABI = require('../abiJson/MdexFactory.json');
const PancakeRouter_ABI = require("../abiJson/PancakeRouter.json");
const PancakeFactory_ABI = require("../abiJson/PancakeFactory.json");
const QuickSwapRouter_ABI = require('../abiJson/QuickSwapRouter.json');
const QuickSwapFactory_ABI = require('../abiJson/QuickSwapFactory.json');

const WarshipNFT_ABI = require('../abiJson/WarshipNFT.json');
const CreateWarship_ABI = require('../abiJson/CreateWarship.json');

const BuildDataBase_ABI = require('../abiJson/BuildDataBase.json');
const BuildOpreta_ABI = require('../abiJson/BuildOpreta.json');
const BuildReward_ABI = require('../abiJson/BuildReward.json');

const WarshipExplore_ABI = require('../abiJson/WarshipExplore.json');
const Production_ABI = require('../abiJson/Production.json');
const InitialMint_ABI = require('../abiJson/InitialMint.json');
const CredaCore_ABI = require('../abiJson/CredaCore.json');
const APIConsumer_ABI = require('../abiJson/APIConsumer.json');
const cPiggyVault_ABI = require('../abiJson/cPiggyVault.json');
const cVault_ABI = require('../abiJson/cVault.json');
const PersonalDataMinePoolPlus_ABI = require('../abiJson/PersonalDataMinePoolPlus.json');
const PersonalDataMinePoolFix_ABI = require('../abiJson/PersonalDataMinePoolFix.json');
const PersonalDataMinePoolV2_ABI = require('../abiJson/PersonalDataMinePoolV2.json');
const PersonalDataMinePoolV2ESC_ABI = require('../abiJson/PersonalDataMinePoolV2ESC.json');
const CNETWORK_ABI = require('../abiJson/cNETWORK.json');
const SushiFactory_ABI = require("../abiJson/SushiFactory.json");
const HomoraBank_ABI = require("../abiJson/HomoraBank.json");
const SushiswapSpellV1_ABI = require("../abiJson/SushiswapSpellV1.json");
const IWMasterChef_ABI = require("../abiJson/IWMasterChef.json");
const IUniswapV2Pair_ABI = require("../abiJson/IUniswapV2Pair.json");
const CreditNFTV2_ABI = require("../abiJson/CreditNFTV2.json");
const Router_ABI = require("../abiJson/Router.json");
